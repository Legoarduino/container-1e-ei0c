...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1e-ei0c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1e-ei0c.containers.anotherwebservice.com/
...
```
git clone git@github.com:Legoarduino/container-1e-ei0c.git
cd container-1e-ei0c
```
...
```
docker attach container-1e-ei0c
```
